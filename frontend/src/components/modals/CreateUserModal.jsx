...
import { X, UserPlus, Mail, Shield, Lock, Eye, EyeOff } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                ...
                {formData.role === 'Sales' && 'Access to leads, opportunities, accounts, and quotes'}
                {formData.role === 'Finance' && 'Access to invoices, payments, and financial reports'}
              </p>
            </div>
            ...
            <div className="flex items-center space-x-3 pt-2">
              ...
              <span className="text-sm font-medium text-gray-700">
                Create as {formData.is_active ? 'Active' : 'Inactive'} user
              </span>
            </div>
